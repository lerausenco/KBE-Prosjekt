# NX 1911
# Journal created by lera_ on Thu Apr 15 11:40:35 2021 W. Europe Summer Time
#
import math
import NXOpen
...
def main() : 
    ...
    cAEFace1 = component1.FindObject("PROTO#CAE_Body(1)|CAE_Face(294)")
    ...
    expression2 = workSimPart.Expressions.CreateSystemExpressionWithUnits("12324", unit2)
    ...
    expression3 = workSimPart.Expressions.CreateSystemExpressionWithUnits("12324", unit2)
